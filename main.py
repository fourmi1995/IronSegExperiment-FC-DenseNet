...
parser.add_argument("--num_classes",   default=4, help="Number of classes", type=int)
parser.add_argument("--learning_rate", default=1e-4,
                    help="Learning rate for optimizer", type=float)
parser.add_argument("--infer_data", default="data/infer")
parser.add_argument("--infer_mask", default="data/mask")
parser.add_argument("--output_folder", default="data/output")
parser.add_argument("--learning_policy", default='poly')
...
def main():
    ...
    if FLAGS.mode == 'train':
        tiramisu.train(FLAGS.train_data, FLAGS.val_data, FLAGS.ckpt,
                       FLAGS.batch_size, FLAGS.epochs, FLAGS.learning_rate,FLAGS.learning_policy)
    elif FLAGS.mode == 'infer':
        tiramisu.infer(FLAGS.infer_data,FLAGS.infer_mask, FLAGS.batch_size, FLAGS.ckpt, FLAGS.output_folder)
